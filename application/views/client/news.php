        ...
        <div class="container h-100">
                <div class="dplay-tbl">
                        <div class="dplay-tbl-cell center-text color-white pt-90">
                                <h5><b>When one place isn't just enough</b></h5>
                                <h3 class="mt-30 mb-15">Latest news and updates</h3>
                        </div><!-- dplay-tbl-cell -->
                </div><!-- dplay-tbl -->
        </div><!-- container -->
</section>
                        ...
                        <div class="col-md-7 col-lg-8">
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo base_url('assets/images/blog-1-1000x400.jpg')?>"" alt="" ">
                                        </div>
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo base_url('assets/images/blog-2-1000x400.jpg')?>"" alt="" ">
                                        </div>
                                ...
                                <div class="mb-50 mb-sm-30">
                                        <div class="pos-relative mb-30 pt-15">
                                                ...
                                                <img src="<?php echo base_url('assets/images/blog-3-1000x400.jpg')?>"" alt="" ">
                                        </div>
